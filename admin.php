        ...
        <?php while ($row = $result_sub_users->fetch_assoc()): ?>
            ...
            <tr id="user-row-<?php echo $row['id']; ?>">
                ...
                <td>
                    ...
                    <input type="tel" class="edit-field" value="<?php echo htmlspecialchars($row['phone']); ?>" style="display: none;">
                </td>
                <td>
                    <div class="user-data">
...
fetch('save_sub_user.php', {
    ...
    body: 'id=' + userId + '&firstname=' + firstname + '&lastname=' + lastname + '&phone=' + phone + '&duties=' + JSON.stringify(selectedDuties)
})
