const chairmanIcon = document.createElement('template');
chairmanIcon.innerHTML = /*html*/ `
...
class ChairmanIcon extends HTMLElement {
  constructor() {
    super();
    ...
    this.shadowRoot.appendChild(chairmanIcon.content.cloneNode(true));
  }
}

customElements.define('chairman-icon', ChairmanIcon);
