const CounterIconTemplate = document.createElement('template');
CounterIconTemplate.innerHTML = /*html*/ `
...
class CounterIcon extends HTMLElement {
  constructor() {
    super();
    ...
    this.shadowRoot.appendChild(CounterIconTemplate.content.cloneNode(true));
  }
}

customElements.define('counter-icon', CounterIcon);
