const RegisterIconTemplate = document.createElement('template');
RegisterIconTemplate.innerHTML = /*html*/ `
...
class RegisterIcon extends HTMLElement {
  constructor() {
    super();
    ...
    this.shadowRoot.appendChild(RegisterIconTemplate.content.cloneNode(true));
  }
}

customElements.define('register-icon', RegisterIcon);
