const DutiesIconTemplate = document.createElement('template');
DutiesIconTemplate.innerHTML = /*html*/ `
...
class DutiesIcon extends HTMLElement {
  constructor() {
    super();
    ...
    this.shadowRoot.appendChild(DutiesIconTemplate.content.cloneNode(true));
  }
}

customElements.define('duties-icon', DutiesIcon);
