const MeetingDaysTemplate = document.createElement('template');
MeetingDaysTemplate.innerHTML = /*html*/ `
...
class MeetingDays extends HTMLElement {
    constructor() {
        super();
        ...
        this.shadowRoot.appendChild(MeetingDaysTemplate.content.cloneNode(true));
    }
}

customElements.define('meeting-days-icon', MeetingDays);