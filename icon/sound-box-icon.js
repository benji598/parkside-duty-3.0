const SoundBoxIconTemplate = document.createElement('template');
SoundBoxIconTemplate.innerHTML = /*html*/ `
...
class SoundBoxIcon extends HTMLElement {
  constructor() {
    super();
    ...
    this.shadowRoot.appendChild(SoundBoxIconTemplate.content.cloneNode(true));
  }
}

customElements.define('sound-box-icon', SoundBoxIcon);
