const RovingMicIconTemplate = document.createElement('template');
RovingMicIconTemplate.innerHTML = /*html*/ `
...
class RovingMicIcon extends HTMLElement {
    constructor() {
        super();
        ...
        this.shadowRoot.appendChild(RovingMicIconTemplate.content.cloneNode(true));
    }
}

customElements.define('roving-mic-icon', RovingMicIcon);