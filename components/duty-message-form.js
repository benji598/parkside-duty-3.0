const DutyMessageFormTemplate = document.createElement('template');
DutyMessageFormTemplate.innerHTML = /*html*/ `
<style>
    :host {
...
class DutyMessageForm extends HTMLElement {
  constructor() {
    ...
    this.shadowRoot.appendChild(DutyMessageFormTemplate.content.cloneNode(true));
  }
...
customElements.define('duty-message-form', DutyMessageForm);
