const PlatformIconTemplate = document.createElement('template');
PlatformIconTemplate.innerHTML = /*html*/ `
...
class PlatformIcon extends HTMLElement {
    constructor() {
        super();
        ...
        this.shadowRoot.appendChild(PlatformIconTemplate.content.cloneNode(true));
    }
}
